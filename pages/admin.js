...
function Admin() {
  ...
  const fetchDetails = async () => {
    const response = await fetch(
      "https://www.ksrbluemetals.site/api/viewOrders"
    );
  ...
  const priceDetails = async () => {
    const response1 = await fetch("https://www.ksrbluemetals.site/api/prices");
  ...
  const deliveryHandller = async (id) => {
    const res = await fetch("https://www.ksrbluemetals.site/api/viewOrders", {
      method: "PUT",
      headers: {
  ...
  const updateHandller = async (data) => {
    ...
    console.log(newPrice[data]);
    const res = await fetch("https://www.ksrbluemetals.site/api/prices", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
